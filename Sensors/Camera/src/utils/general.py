...
LOGGER = set_logging('yolov5', verbose=False)  # define globally (used in train.py, val.py, detect.py, etc.)
...
def xyxy2xywh(x):
    # TODO: Optimizations - torch.empty(x.shape) instead of x.clone. remove np.copy, isinstance for speed (will remove np compatibility)
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    # Important Note: If we start to use multi-label, we will end up with significantly more time.
